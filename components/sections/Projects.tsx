...
import { ArrowRight, ShieldAlert, Cpu, Eye, CheckCircle2, BarChart2 } from 'lucide-react'
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-20 md:py-28 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
      <AnimatedSection>
        <SectionHeader
          badge="SELECTED SYSTEMS"
          title="SELECTED SYSTEMS"
          subtitle="Production-oriented AI platforms, deep-learning models, and full-stack intelligent systems."
        />
      </AnimatedSection>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
        {/* FLAGSHIP PROJECT: GRADIORA (Full Width 12 cols when ALL or AI/ML selected) */}
              ...
              <div className="ui-card p-8 md:p-10 bg-dark-card border-dark-border hover:border-violet-primary/60 transition-all relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
                  ...
                  <div className="lg:col-span-7">
                    ...
                    <div className="text-sm font-mono text-violet-highlight/90 mb-4">
                  ...
                  {/* Right Column: Abstract Interactive SaaS UI Mockup (5 cols) */}
                  <div className="lg:col-span-5">
                    <div className="bg-dark-elevated border border-dark-border p-5 rounded-xl space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between text-xs p-2 rounded bg-dark-card border border-dark-border">
                          <span className="text-light-secondary">Financial Risk Model</span>
                          <span className="font-mono text-violet-highlight font-bold">0.08 Low</span>
                        </div>
                      </div>

                      {/* SHAP preview */}
                      <div className="p-3 rounded bg-violet-primary/10 border border-violet-primary/30 text-xs">
                        <div className="text-[0.6rem] font-mono text-violet-highlight uppercase mb-1">SHAP FACTOR ANALYSIS</div>
                        <div className="text-[0.7rem] text-light-secondary">Attendance drop (-24%) + Exam threshold signal</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* OTHER PROJECTS (Asymmetric Grid 6 cols each) */}
